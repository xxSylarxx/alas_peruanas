<div>
    ...
    <p style="color: var(--color2);"> <span class="mr-3"> <i class="fas fa-calendar-alt" aria-hidden="true"></i></span> 10-07-2022</p>

    <h3 class="text-uppercase" style="color: var(--color1);">CAMPEONATO NACIONAL DE AJEDREZ</h3>
