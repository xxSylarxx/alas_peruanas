        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="d-flex justify-content-center " style="color:var(--color1);">
                    <h2>ORIENTACIÓN EDUCATIVA Y CONVIVENCIA ESCOLAR (COECE):</h2>
                </div>
                ...
                <p style="line-height: 2;">
                    ...
                    emocional que les permita mantener un óptimo desarrollo en todas las esferas que
                    involucran el desarrollo del ser.
                    Buscamos mantener la convivencia positiva y mantener el vínculo entre los docentes
                    y los estudiantes, así como entre sus pares; procurando evitar desequilibrios
                ...
                <p style="line-height: 2;">
                    ...
                    de participación de los estudiantes para favorecer los factores protectores en el
                    marco de su desarrollo integral, así como la atención y participación de las familias,
                    favoreciendo la convivencia escolar democrática en esta nueva modalidad de atención
                    educativa híbrida.
                </p>
            </div>
        </div>
