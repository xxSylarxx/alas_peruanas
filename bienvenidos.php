  ...
  <div class="separador mx-start"></div>
    ...
    <section id="bienvenidos-interno">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div style="padding-top:1.8rem;padding-bottom:1.8rem;color:var(--color7);">Inicio&nbsp; >&nbsp; Nosotros &nbsp;>&nbsp; <span style="color:var(--color1);">Bienvenidos</span></div>
                </div>
            </div>
            <div class="row">
            <div class="row">
            <div class="col-md">
                <div class="card  shadow">
                    <div class="card-body text-justify" style="padding: 6%;">
                        <div class="row ">
                               <center> <div style="color:var(--color1);"><h1>Bienvenidos</h1></div></center>
                            ...
                            <br>
                            <p>
                                    Bienvenidos a los Colegios Alas Peruanas y gracias por considerarnos como una posibilidad para la educación de sus hijos.
                            </p>

                            <p>
                            Contamos con dos colegios uno ubicado en la ciudad de Arequipa y el otro en la ciudad de Ica, ambas instituciones forman parte de la promotora Inversiones Educativas IESCOOP SAC. Tenemos una amplia experiencia; el colegio de Arequipa quien cumple  30 años de servicio y el colegio de Ica quien cumple 23 años sirviendo a la comunidad de Ica.
                            </p>
                            <p>
                            Nuestra vocación es lo que nos lleva día a día a seguir innovando y trabajar para formar alumnos íntegros con una sólida formación en valores y trabajar en colaboración con los padres de familia de nuestros colegios ya que ustedes papás, son un pilar importante en la educación de sus hijos.
                            </p>
                            <p>
                            Las habilidades de cómo aprender, investigar, liderar, colaborar y comunicar sus aprendizajes se desarrollan a lo largo de su educación en Alas Peruanas. Pero su aprendizaje también sucede también fuera de las aulas, y buscamos que los estudiantes sean conscientes de cómo las habilidades se usan en otras actividades.
                            </p>
                            <p>
                                Nuestro Proyecto Educativo Institucional desarrolla un plan académico que permita desarrollar las habilidades de pensamiento crítico y creativo de nuestros alumnos.
                            </p>
                            <p>
                             Trabajamos en la formación de la niñez y la juventud, tratando de incentivar el deseo de un liderazgo positivo, basado en valores, con capacidad de proveer el futuro, como premisa para hacer frente a los grandes desafíos del mundo en que vivimos, buscando siempre el bienestar y progreso de la sociedad.
                            </p>
                            <p>
                                Te invito a conocer más sobre nuestra familia educativa a través de esta página Web, un espacio de encuentro que ponemos a tu disposición.
                            </p>
                        
                        <br>                        
                        <center><img src="./public/img/img-page/bienvenidos.jpeg" style="width:60%;height:60%;" class="rounded shadow-sm"></center>
                        <br>
                        <center><span style="color:var(--color3);font-weight:bold;">Lic. German V. Chipana Huanca</span></center>
                        <center><span style="color:var(--color1);font-weight:bold;">Director</span></center>
