                ...
                <div class="col-lg-12">
                    <h2 class="ml6">
                        <span class="text-wrapper">
                            <span class="letters">Inicio&nbsp; /&nbsp; Nosotros &nbsp;/&nbsp; <span id="rutaprincipal">Reglamento Interno</span>
                            </span>
                        </span>
    ...
    <section class="container">
        <div class="row py-5">
            <div class="col-lg-12">
                ...
                <br>
                <h1 style="text-align:center;color:var(--color1);">Reglamento Interno</h1>
        ...
        <div class="row justify-content-around mt-4 pt-4">
            <iframe src="./public/files/reglamento.pdf" class="shadow" frameborder="0" width="100%" height="900"></iframe>
        </div>
    </section>
    <br>
    <br>
