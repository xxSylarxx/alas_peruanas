        ...
        <div class="container-fluid">
            <div class="row d-flex justify-content-between">
                ...
                <div class="col-lg-6 p-0">
                    <img src="./public/img/img-page/arequipa/secundariaf1.jpg" width="100%" height="500" style="object-fit:cover;" alt="">
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row d-flex justify-content-between">
                <div class="col-lg-6 p-0">
                    <img src="./public/img/img-page/arequipa/secundariaf2.jpg" width="100%" height="500" style="object-fit:cover;" alt="">
                </div>
