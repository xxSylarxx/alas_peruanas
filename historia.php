...
<body id='cuerpo'>
    ...
    <style>
        ...
        #lema {
            background: linear-gradient(rgba(136, 28, 34, 0.8) 100%, #ffff 10%, #ffff 50%),
                url('./public/img/img-page/bienvenidos.jpg');
            background-size: 100%;
    ...
    <section class="container" id="historiaa">
        <div class="row">
            <div class="col-md">
                <div class="card  shadow" style="background-color:transparent!important;">
                    <div class="card-body text-justify" style="padding: 6%;">
                        ...
                        <br>
                        <p>
                            Bienvenidos a los Colegios Alas Peruanas y gracias 
                            por considerarnos como una posibilidad para la educación de sus hijos.
                        </p>
                        <p>
                            Contamos con dos colegios uno ubicado en la ciudad de Arequipa y el otro 
                            ...
                            de Ica quien cumple 23 años sirviendo a la comunidad de Ica.
                        </p>
                        <p>
                            Nuestra vocación es lo que nos lleva día a día a seguir innovando y 
                        ...
                        <p>
                            Nuestro Proyecto Educativo Institucional desarrolla un plan académico 
                            que permita desarrollar las habilidades de pensamiento crítico y 
                            creativo de nuestros alumnos.
                        </p>
                        <p>
                            Trabajamos en la formación de la niñez y la juventud, 
                            tratando de incentivar el deseo de un liderazgo positivo, 
                            basado en valores, con capacidad de proveer el futuro, como 
                            premisa para hacer frente a los grandes desafíos del mundo en 
                            que vivimos, buscando siempre el bienestar y progreso de la sociedad.
                        </p>
                        <p>Te invito a conocer más sobre nuestra familia educativa a 
                            través de esta página Web, un espacio de encuentro
                             que ponemos a tu disposición.</p>
                        <br>
                        <center><h3>Lic. German V. Chipana Huanca</h3></center>
                        <center><h5>Director</h5></center>
                    </div>
                </div>
            </div>
        </div>
