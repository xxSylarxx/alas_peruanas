...
<body id='cuerpo'>
    ...
    <section id="bienvenidos-interno">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div style="padding-top:1.8rem;padding-bottom:1.8rem;color:var(--color7);">Inicio&nbsp; >&nbsp; Nosotros &nbsp;>&nbsp; <span style="color:var(--color1);">Reseña Histórica</span></div>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row py-5">
                <div class="col-lg-12">
                    ...
                    <br>
                    <h1 style="text-align:center;color:var(--color1);">Reseña Histórica</h1>
            ...
            <div class="row d-flex justify-content-between">
                <div id="bienvenidos-parrafo2" class="col-lg-6 p-0">
                    <div style="padding: 5rem;">
                        ...
                        <br>
                        <p class="px-3 text-white">Institución Educativa ubicada en la Urb. Aproviord B-6 
                        ...
                        <p class="px-3 text-white">Con Resolución Directoral 01256 de la Dirección Regional 
