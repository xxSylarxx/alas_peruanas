    ...
    <!--   <section class="container">
        <div class="row py-5">
            <div class="col-lg-12">
                ...
                <br>
                <h1 style="text-align:center;color:var(--color1);">PROCESO DE ADMISIÓN 2023</h1>
            ...
            <div class="row d-flex justify-content-between">
                <div id="bienvenidos-parrafo" class="col-lg-12 p-0">
                    <div class="my-auto" style="padding: 3rem;">
                        <center>
                            <h2 style="text-align:center;color:var(--color1);">¡Muchas gracias por tu interés en formar parte de la Familia Alas Peruanas!</h2>
                        </center>
                        <br>
                        <!-- <p>El servicio se encuentra a cargo de una enfermera. Incluye la atención y
                            orientación a toda la Comunidad Alariana a través de:</p> -->
                        <p>Queremos saludarlos y agradecerles por su interés
                            en nuestra Institución educativa, y le damos a conocer
                            el PROCESO DE ADMISIÓN: Dirigido a postulantes a Inicial,
                            Primaria y Secundaria. La elección para postular a sus hijos
                            es una decisión muy importante que deben tomar como familia y
                            para ello deben contar con la información necesaria. </p>
                        <p>Nuestro especial agradecimiento a todas las familias que
                            participan de este proceso, en especial a aquellas que al
                            confirmar su vacante nos depositan su confianza.</p>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="accordion-item ">
                                    <h2 class="accordion-header" id="flush1">
                                        <button class="accordion-button collapsed bg-body " type="button" data-bs-toggle="collapse" data-bs-target="#item1" aria-expanded="false" aria-controls="item1">
                                            ...
                                            <div class="w-100 title-pe mx-3">1.-PROCESO DE ADMISIÓN</div>
                                        </button>
                                    </h2>
                                    <div id="item1" class="accordion-collapse collapse show" aria-labelledby="flush1" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body">
                                            <div class="d-flex flex-row">
                                                <span>
                                                    <ul>
                                                        <li>Solicitar información general – Oficina de Admisión del Colegio.</li>
                                                        <li>Coordinar Fecha de Entrevista.</li>
                                                        <li>Asistir a la Visita guiada por la Institución Educativa.</li>
                                                        <li>Asistir a la entrevista para padres e hijos en la fecha coordinada.</li>
                                                        <li>Apersonarse al Colegio para solicitar los
                                                            resultados en la fecha indicada – Oficina de admisión de la Institución.
                                                        </li>
                                                    </ul>
                                ...
                                <div class="accordion-item ">
                                    <h2 class="accordion-header" id="flush2">
                                        <button class="accordion-button collapsed bg-body " type="button" data-bs-toggle="collapse" data-bs-target="#item2" aria-expanded="false" aria-controls="item2">
                                            <div class="boton-icono"><i class="fas fa-caret-right"></i></div>
                                            <div class="w-100 title-pe mx-3">2.- DOCUMENTOS REQUERIDOS PARA POSTULACIÓN</div>
                                        </button>
                                    </h2>
                                    <div id="item2" class="accordion-collapse collapse" aria-labelledby="flush2" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body">
                                            <div class="d-flex flex-row">
                                                <span>
                                                    <ul>
                                                        <li>Libreta de Notas o Carnet de Vacunación (3 Años).</li>
                                                        ...
                                                        <li>Constancia de no adeudo del colegio de donde procede.</li>
                                                        <li>Documentación en mica
                                                            tamaño oficio y folders
                                                            de color azul de cartulina.</li>
                                                    </ul>
                                                </span>
                                            </div>
                                        </div>
