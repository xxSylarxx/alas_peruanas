...
<body id='cuerpo'>
    ...
    <style>
        ...
        #portada {
            ...
            background: linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 1)),
                url('./public/img/img-page/arequipa/portada_deportes.jpg');
            /* background:linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 1)); */
            background-size: 100%;
            /* background-position: center; */
            background-attachment: fixed;
        ...
        <div class="container">
            <div class="row d-flex justify-content-around">
                <div class="col-lg-6 mt-4 mb-4">
                    <h1 style="text-align:start;color:var(--color3);">Deportes</h1>
                    <div class="separador mx-start"></div>
                ...
                <div class="col-lg-5 mt-4 mb-4">
                    <div class="row ">
                        <div class="col-lg">
                            <p>El desarrollo integral de la persona necesita el balance y equilibrio que
                                permite una vida saludable. No sólo buscamos que los niños y jóvenes se
                                familiaricen con un deporte en específico,
                                sino también brindamos la oportunidad de desarrollar habilidades,
                                interactuar con sus pares, desarrollar y potenciar valores como la tolerancia,
                                responsabilidad, fortaleza, el equilibrio, la constancia y la disciplina.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row d-flex justify-content-around">
                <div class="col-lg-4 mt-4 mb-4">
                    ...
                    <h1 style="text-align:start;color:var(--color1);">Arte</h1>
                    <div class="separador mx-start"></div>
                </div>
                <div class="col-lg-8 mt-4 mb-4">
                    <div class="row ">
                        <div class="col-lg mx-3">
                            <p>A través del Área de Arte brindamos la posibilidad a
                                cada alumno para que explore sus talentos y habilidades
                                artísticas encontrando la mejor manera de expresarse.
                                Buscamos que nuestros alumnos desarrollen la creatividad,</p>

                        </div>
                        <div class="col-lg mx-3">
                            <p>
                                la imaginación, la sensibilización, la valoración y las
                                diferentes formas de expresión, elementos muy necesarios
                                para consolidar el carácter en la persona.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-6 p-0 ">
                <div class="flip mx-1">
                    <div class="card shadow ">
                        <div class="front ">
                            <span class="fs-1"><img src="./public/img/icons/deporte_ajedrez.png" width="50" alt=""></span>
                            <h5 class="py-2">Ajedrez</h5>
                        </div>
                        <div class="back">
                            <p>
            ...
            <div class="col-lg-6 p-0 ">
                <div class="flip mx-1">
                    <div class="card shadow ">
                        <div class="front ">
                            <span class="fs-1"><img src="./public/img/icons/deporte_futbol.png" width="50" alt=""></span>
                            <h5 class="py-2">Fútbol</h5>
                        </div>
                        <div class="back">
                            <p>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit.
            ...
            <div class="col-lg-6 p-0 ">
                <div class="flip mx-1">
                    <div class="card shadow ">
                        <div class="front ">
                            <span class="fs-1"><img src="./public/img/icons/deporte_natacion.png" width="50" alt=""></span>
                            <h5 class="py-2">Natación</h5>
                        </div>
                        <div class="back">
                            <p>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit.
            ...
            <div class="col-lg-6 p-0 ">
                <div class="flip mx-1">
                    <div class="card shadow ">
                        <div class="front ">
                            <span class="fs-1"><img src="./public/img/icons/deporte_voleyball.png" width="50" alt=""></span>
                            <h5 class="py-2">Voley</h5>
                        </div>
                        <div class="back">
                            <p>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit.
            ...
            <div class="row h-100">
                <div class="col-md-4 my-auto">
                    <div class="card border-0" id="card-1">
                        <div class="crop">
                            <img src="https://smaschoolperu.edu.pe/assets/img/fotos/valores_amor.jpg" class="w-100">
                        </div>
                ...
                <div class="col-md my-auto">
                    <div class="card border-0">
                        <div class="card-body" id="card-1-1">
                            <h5 class="font-weight-bold text-secu" style="color:var(--color1);font-weight:bold;">Artes Visuales - Dibujo y pintura:</h5>
                            <div class="d-flex flex-row align-item-center mb-2">
                                <span class="text-prim"><i class="fa fa-check-circle" aria-hidden="true"></i></span>
                                <span class="ms-2">El desarrollo gráfico plástico,
                                    artes visuales, permite a través del dibujo,
                                    la pintura, que los alumnos desarrollen la imaginación,
                                    creatividad, expresividad, sentido estético, pensamiento
                                    crítico y apreciación de la belleza.</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row h-100">
                <div class="col-md-4 my-auto">
                    <div class="card border-0" id="card-1">
                        ...
                        <div class="w-100 h-100 bg-trans px-4">
                            <br><br><br>
                            <h2>Artes Interpretativas</h2>
                            <p class="font-weight-bold text-center">Teatro</p>
                        </div>
                    </div>
                </div>
                <div class="col-md my-auto">
                    <div class="card border-0">
                        <div class="card-body" id="card-1-1">
                            <h5 class="font-weight-bold text-secu" style="color:var(--color1);font-weight:bold;">Artes Interpretativas - Teatro:</h5>
                            <div class="d-flex flex-row align-item-center mb-2">
                                <span class="text-prim"><i class="fa fa-check-circle" aria-hidden="true"></i></span>
                                <span class="ms-2">El teatro permite la expresión 
                                    y comunicación a través del cuerpo, valiéndose 
                                    de gestos, movimientos y, generalmente, palabras 
                                    para contar algo.</span>
                            </div>
                ...
                <div class="col-md-4 my-auto">
                    <div class="card border-0" id="card-1">
                        ...
                        <div class="w-100 h-100 bg-trans px-4">
                            <br><br><br>
                            <h2>Artes Interpretativas</h2>
                            <p class="font-weight-bold text-center">Danza</p>
                        </div>
                    </div>
                </div>
                <div class="col-md my-auto">
                    <div class="card border-0">
                        <div class="card-body" id="card-1-1">
                            <h5 class="font-weight-bold text-secu" style="color:var(--color1);font-weight:bold;">Artes Interpretativas - Danza:</h5>
                            <div class="d-flex flex-row align-item-center mb-2">
                                <span class="text-prim"><i class="fa fa-check-circle" aria-hidden="true"></i></span>
                                <span class="ms-2">Con la danza se integra 
                                    el movimiento, las emociones y la imaginación 
                                    como manifestación cultural y celebración de 
                                    la vida en movimiento.</span>
                            </div>
                ...
                <div class="col-md-4 my-auto">
                    <div class="card border-0" id="card-1">
                        ...
                        <div class="w-100 h-100 bg-trans px-4">
                            <br><br><br>
                            <h2>Artes Interpretativas</h2>
                            <p class="font-weight-bold text-center">Música</p>
                        </div>
                    </div>
                </div>
                <div class="col-md my-auto">
                    <div class="card border-0">
                        <div class="card-body" id="card-1-1">
                            <h5 class="font-weight-bold text-secu" style="color:var(--color1);font-weight:bold;">Artes Interpretativas - Música:</h5>
                            <div class="d-flex flex-row align-item-center mb-2">
                                <span class="text-prim"><i class="fa fa-check-circle" aria-hidden="true"></i></span>
                                <span class="ms-2">La música forma parte del juego 
                                    con el sonido, ya sea a través del canto o 
                                    la interpretación de instrumentos.</span>
                            </div>
