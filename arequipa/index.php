            ...
            <div class="row mt-5">
                <div class="col-md mt-4">
                    <div class="card h-100">
                        <figure class="m-0">
                            <img src="./public/img/img-page/arequipa/portada_inicial.jpg" alt="inicial">
                ...
                <div class="col-md mt-4">
                    <div class="card h-100">
                        <figure class="m-0">
                            <img src="./public/img/img-page/arequipa/portada_primaria.jpg" alt="primaria">
                            <div class="figure-overlay d-flex justify-content-center align-items-center position-absolute w-100 h-100">
                ...
                <div class="col-md mt-4">
                    <div class="card h-100">
                        <figure class="m-0">
                            <img src="./public/img/img-page/arequipa/secundaria.jpg" alt="secundaria">
                            <div class="figure-overlay d-flex justify-content-center align-items-center position-absolute w-100 h-100">
