    ...
    <style>
        ...
        #portada {
            background: linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 1)),
                url('./public/img/img-page/arequipa/secundaria.jpg');
            /* background:linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 1)); */
            background-size: 100%;
            /* background-position: center; */
            background-attachment: fixed;
        ...
        <div class="container-fluid">
            <div class="row d-flex justify-content-between">
                ...
                <div class="col-lg-6 p-0">
                    <img id="img-parrafo" src="./public/img/img-page/arequipa/secundariaf1.jpg" width="100%" height="500" style="object-fit:cover;" alt="">
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row d-flex justify-content-between">
                <div class="col-lg-6 p-0">
                    <img id="img-parrafo" src="./public/img/img-page/arequipa/secundariaf2.jpg" width="100%" height="500" style="object-fit:cover;" alt="">
                </div>
