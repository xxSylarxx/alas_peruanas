            ...
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="ml6">
                        ...
                        <span class="letters" style="font-size:50px;">Enfermería
                            </span>
                            </span>
                        </span>
    ...
    <section class="container">
        <div class="row py-5">
            <div class="col-lg-12">
                ...
                <br>
                <h1 style="text-align:center;color:var(--color1);">Servicio de Enfermería</h1>
        ...
        <div class="container-fluid">
            <div class="row d-flex justify-content-between">
                <div id="bienvenidos-parrafo"  class="col-lg-6 p-0">
                    <div class="my-auto" style="padding: 5rem;">
                      
                        <p>Nuestra Enfermería brinda atención primaria de salud 
                            a toda la Comunidad, a través de una atención oportuna 
                            e integral, programas de promoción de la salud, 
                            prevención de enfermedades y atención directa al alumnado y personal.
                        </p>
                        <p>El servicio se encuentra a cargo de una enfermera. Incluye la atención y orientación a toda la Comunidad Alariana a través de:</p>

                        <ul>
                            <li>Primeros Auxilios.</li>
                            <li>Aplicación de medicamentos de acuerdo a prescripción médica.</li>
                            <li>Suministro de medicamentos básicos para enfermedades comunes.</li>
                        </ul>
                        <p style="font-weight:bold;font-style:italic;">*La Enfermería no brinda diagnósticos ni receta medicamentos que requieran prescripción médica.</p>
                    </div>
                </div>
                <div class="col-lg-6 p-0">
                    <img src="./public/img/img-page/arequipa/enfermeria.jpeg" height="500" width="100%" style="object-fit:cover;" alt="">
                </div>
            </div>
        </div>
