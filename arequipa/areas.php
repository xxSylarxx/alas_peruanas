...
<body id='cuerpo'>
    ...
    <section id="bienvenidos-interno">
        ...
        <div class="container">
            <div class="row d-flex justify-content-around">
                ...
                <div class="col-lg-6 mt-4 mb-4">
                    <center><img src="./public/img/img-page/arequipa/arte.jpg" width="98%" alt=""></center>
                </div>
    ...
    <section id="bienvenidos-interno2">
        ...
        <div class="container">
            <div class="row d-flex justify-content-around">
                <div class="col-lg-6 mt-4 mb-4">
                    <center><img src="./public/img/img-page/arequipa/computacion.jpg" width="90%" alt=""></center>
                </div>
    ...
    <section id="bienvenidos-interno2">
        ...
        <div class="container">
            <div class="row d-flex justify-content-around">
                <div class="col-lg-6 mt-4 mb-4">
                    <center><img src="./public/img/img-page/arequipa/ingles.jpg" width="87%" alt=""></center>
                </div>
                <div class="col-lg-6 my-auto">
