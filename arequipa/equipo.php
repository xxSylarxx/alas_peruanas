...
<body id='cuerpo'>
                ...
                <div class="col-lg-12">
                    <h2 class="ml6">
                        <span class="text-wrapper">
                            ...
                            <!-- <span class="letters">Inicio&nbsp; /&nbsp; Nosotros &nbsp;/&nbsp; <span id="rutaprincipal">Equipo</span>
                            </span> -->
                        </span>
    ...
    <div class="row py-5">
            <div class="col-lg-12">
                ...
                <br>
                <h2 style="text-align:center;color:var(--color1);">Conoce a nuestro equipo</h2>
                <!-- <div class="separador mx-auto"></div> -->
            </div>
        </div>
        <div class="row py-3">
            <div class="col-lg-12">
                <p style="text-align:center;">La comunidad Alas Peruanas está conformada por administrativos, personal docente, auxiliares y colaboradores<br> los que trabajan al servicio de la formación de futuros ciudadanos.</p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="card" style="border: 0;">
                    <div class="card-body text-center">
                        <img src="./public/img/img-page/arequipa/coordinador_academico2.jpg" class="w-75 rounded-circle shadow">
                        <br><br>
                        <p class="prim text-center">Lic. Juan Eduardo Bernal Carpio</p>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h4 style="color:var(--color1);">Equipo Pedagógico</h4>
                <p>Contamos con un equipo altamente capacitado:</p>
                <div class="row">
                    <div class="col-lg-12 ">
                        <div class="d-flex">
                            <p class="mx-4"><i class="fas fa-check-circle"></i>&nbsp;&nbsp;30 docentes</p>
                        </div>
                    </div>
                </div>
                ...
                <br>
                <br>
                <h4 style="color:var(--color1);">Equipo No Docente:</h4>
                <p> Equipo que está capacitado para brindar soporte para el funcionamiento óptimo de nuestro día a día:</p>
                <div class="row">
                    <div class="col-lg-12 ">
                        <div class="d-flex">
                            <p class="mx-4"><i class="fas fa-check-circle"></i>&nbsp;&nbsp;Secretaría General</p>
                        </div>
                        <div class="d-flex">
                            <p class="mx-4"><i class="fas fa-check-circle"></i>&nbsp;&nbsp;Área de Admisión</p>
                        </div>
                        <div class="d-flex">
                            <p class="mx-4"><i class="fas fa-check-circle"></i>&nbsp;&nbsp;Departamento psicológico</p>
                        </div>
                        <div class="d-flex">
                            <p class="mx-4"><i class="fas fa-check-circle"></i>&nbsp;&nbsp;Área Marketing y publicidad de Relaciones Públicas</p>
                        </div>
                        <div class="d-flex">
                            <p class="mx-4"><i class="fas fa-check-circle"></i>&nbsp;&nbsp;Tópico - Enfermería</p>
                        </div>
