            ...
            <div class="row d-flex justify-content-around">
                ...
                <div class="col-lg-5 mt-4 mb-4">
                    <div class="row ">
                        <div class="col-lg">
                            <p>
                                Nuestro Colegio cuenta con un área de 2,134.73 m2 de moderna infraestructura antisísmica,
                                adecuada a las necesidades de todas las edades de nuestros alumnos.
                            </p>
                            <p>
                                Presenta dos pabellones,
                                un patio central, una losa deportiva, área recreacional para inicial y primaria,
                                áreas verdes,laboratorio de física y química, laboratorio de cómputo,Biblioteca, Video teca, Sala de música
                                y laboratorio de robótica que es, una herramienta pedagógica entretenida e innovadora que cada día
                                cobra mayor importancia, ya que a través de actividades lúdicas los estudiantes desarrollan
                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="./public/img/img-page/arequipa/infra_patio.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="./public/img/img-page/arequipa/infra_biblioteca.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="./public/img/img-page/arequipa/infra_patioCentral.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="./public/img/img-page/arequipa/infra_laboratorio.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="./public/img/img-page/arequipa/infra_patio2.jpg" class="d-block w-100" alt="...">
                        </div>
                    </div>
