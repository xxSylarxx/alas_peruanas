    ...
    <section id="metodologicos">
        <div class="container">
            ...
            <div class="row pt-5">
                ...
                <div class="col-lg-4">
                    <h5> El acompañamiento permanente</h5>
                    <p>Permite que los estudiantes logren el máximo desarrollo de sus potencialidades, capacidades y establecimiento de metas.
                ...
                <div class="col-lg-4">
                    ...
                    <p>Es constante en la comunidad educativa, el encuentro entre
                        ...
                        diálogo y propiciar espacios de reflexión.
                    </p>
                </div>
            </div>
            <div class="row pt-5">
                <div class="col-lg-4">
                    <h5>La evaluación formativa</h5>
                ...
                <div class="col-lg-4">
                    <h5>El enfoque de investigación</h5>
            ...
            <div class="row pt-5">
                <div class="col-lg-4">
                    <h5>Valores de la institución educativa</h5>
