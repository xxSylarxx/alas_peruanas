        ...
        <div class="container">
            <div class="row d-flex justify-content-around">
                ...
                <div class="col-lg-5 mt-4 mb-4">
                    <div class="row ">
                        <div class="col-lg">
                            <p>Nuestro proyecto curricular en el nivel secundaria profundiza y afianza una formación científica, humanística y tecnológica a los adolescentes. El perfil de nuestros estudiantes se orienta al desarrollo de competencias para la vida, el trabajo y el ejercicio de la ciudadanía, desarrollándose en grupos heterogéneos y de un modo autónomo. El desarrollo de habilidades tecnológicas mediante la adquisición de habilidades de cómputo, centrándonos en el manejo de los principales programas y herramientas digitales y otros.</p>
                            <p>La enseñanza la impartimos tomando en cuenta los desempeños establecidos por cada área curricular y que se encuentran alineados a las competencias, capacidades y estándares de aprendizaje propuestos en el Currículo Nacional que son evaluados formativamente.</p>
            ...
            <div class="row d-flex justify-content-between">
                <div id="bienvenidos-parrafo" class="col-lg-6 p-0">
                    <div style="padding: 5rem;">
                        ...
                        <br>
                        <p>Se ofrece orientación vocacional que facilite su desempeño como futuros
                            ciudadanos libres, en la sociedad, teniendo en cuenta las características, necesidades y
            ...
            <div class="row d-flex justify-content-between">
                ...
                <div id="bienvenidos-parrafo2" class="col-lg-6 p-0">
                    <div style="padding: 5rem;">
                        ...
                        <h2 style="color:black;">DESARROLLO CIENTÍFICO INVESTIGATIVO</h2>
                        <br>
                        <p class="card_text">Promueve el desarrollo de capacidades y actitudes
                            investigativas orientadas profundizar en las diversas áreas de las ciencias y humanidades.</p>
                    </div>
                </div>
            </div>
        </div>
