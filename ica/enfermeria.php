    ...
    <style>
        ...
        #portada {
            background: linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 1)),
                url('./public/img/img-page/ica/infraestructura3.jpg');
            /* background: linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 1)),
        ...
        <div class="container">
            <div class="row d-flex justify-content-around">
                <div class="col-lg-6 mt-4 mb-4">
                    ...
                    <h1 style="text-align:start;color:var(--color3);">Enfermería</h1>
                    <div class="separador mx-start"></div>
                ...
                <div class="col-lg-5 mt-4 mb-4">
                    <div class="row ">
                        <div class="col-lg">
                            ...
                            <p style="font-style:italic;">*La Enfermería no brinda diagnósticos ni receta medicamentos que requieran prescripción médica.</p>
                        </div>
