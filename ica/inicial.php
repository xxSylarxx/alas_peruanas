    ...
    <style>
        ...
        #portada {
            background: linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 1)),
                url('./public/img/img-page/ica/portada_inicial.jpg');
            /* background:linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 1)); */
            background-size: 100%;
            /* background-position: center; */
            background-attachment: fixed;
        ...
        <div class="container">
            <div class="row d-flex justify-content-around">
                <div class="col-lg-6 mt-4 mb-4">
                    ...
                    <h1 style="text-align:start;color:var(--color3);">Inicial</h1>
                    <div class="separador mx-start"></div>
                ...
                <div class="col-lg-5 mt-4 mb-4">
                    <div class="row ">
                        <div class="col-lg">
                            <p>La educación en el nivel inicial de los Colegios Alas Peruanas, 
                                se centra en la atención integral de niños y niñas de 3, 
                                4 y 5 años. Es el nivel que establece las bases de la 
                                formación de una personalidad integra y protagónica, a 
                                través de su participación activa en los contextos 
                                de juego y en los proyectos.</p>
                            <p>El proceso de enseñanza aprendizaje, tiene como base 
                                el Currículo Nacional y el proyecto Educativo institucional
                                 Alas Peruanas.</p>
                            <p>En este nivel se sientan las bases para el desarrollo de 
                                las competencias biológicas, afectivas y sociales de los
                                 niños y niñas con acciones educativas que facilitan la 
                                 experiencia directa y la participación de la familia, 
                                 que apoya con gran entusiasmo las actividades propuestas.</p>
                            <p>Es importante el trabajo conjunto entre padres de 
                                familia y docentes. El acompañamiento constante de 
                                los alumnos se completa con la comunicación de las 
                                tutoras con los padres de familia.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row d-flex justify-content-between">
                <div id="bienvenidos-parrafo" class="col-lg-6 p-0">
                    <div style="padding: 5rem;">
                        ...
                        <br>
                        <p>A través del juego, el niño y la niña se apropian del mundo y sus relaciones con los demás,
                            resuelve conflictos y pone a prueba su inventiva; así mismo es mediado por los demás.
                        </p>

                    </div>
                </div>
                <div class="col-lg-6 p-0">
                    <img id="img-parrafo" src="./public/img/img-page/ica/inicial1.jpg" width="100%" height="500" style="object-fit:cover;" alt="">
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row d-flex justify-content-between">
                <div class="col-lg-6 p-0">
                    <img id="img-parrafo" src="./public/img/img-page/ica/inicial2.jpg" width="100%" height="500" style="object-fit:cover;" alt="">
                </div>
                <div id="bienvenidos-parrafo2" class="col-lg-6 p-0">
                    <div style="padding: 5rem;">
                        <img src="./public/img/icons/identidad.png" alt="">
                        <h2 style="color:black;">FORMACIÓN DE LA IDENTIDAD</h2>
                        <br>
            ...
            <div class="row d-flex justify-content-between">
                <div id="bienvenidos-parrafo" class="col-lg-6 p-0">
                    <div style="padding: 5rem;">
                        ...
                        <h2>PROTAGONISMO INFANTIL</h2>
                        <br>
                        <p>La participación activa de los niños y
                            niñas desarrolla el compromiso y la dedicación; ello implica desarrollar la capacidad de trabajar solidariamente a partir de consensos.
                        </p>

                    </div>
                </div>
                <div class="col-lg-6 p-0">
                    <img id="img-parrafo" src="./public/img/img-page/ica/inicial3.jpg" width="100%" height="500" style="object-fit:cover;" alt="">
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row d-flex justify-content-between">
                <div class="col-lg-6 p-0">
                    <img id="img-parrafo" src="./public/img/img-page/ica/inicial4.jpg" width="100%" height="500" style="object-fit:cover;" alt="">
                </div>
                <div id="bienvenidos-parrafo2" class="col-lg-6 p-0">
                    <div style="padding: 5rem;">
                        <img src="./public/img/icons/habilidades.png" alt="">
                        <h2 style="color:black;">DESARROLLO DE HABILIDADES</h2>
                        <br>
                        <p>Se desarrolla habilidades para el desarrollo de destrezas motrices,
                            gruesas y finas.Se empieza a desarrollar el proceso de lectura y escritura.
                        </p>
