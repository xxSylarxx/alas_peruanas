...
<body id='cuerpo'>
    ...
    <style>
        ...
        #lema {
            background: linear-gradient(rgba(136, 28, 34, 0.8) 100%, #ffff 10%, #ffff 50%),
                url('./public/img/img-page/ica/portada_arte.jpg');
            background-size: 100%;
        ...
        <div class="container">
            <div class="row d-flex justify-content-around">
                <div class="col-lg-6 mt-4 mb-4">
                    ...
                    <h1 style="text-align:start;color:var(--color3);">Arte</h1>
                    <div class="separador mx-start"></div>
                    ...
                    <div class="row ">
                        <div class="col-lg">
                            <p>A través del Área de Arte brindamos la posibilidad a
                                ...
                                Buscamos que nuestros alumnos desarrollen la creatividad,a
                                imaginación, la sensibilización, la valoración y las
            ...
            <div class="col-lg-6 p-0 ">
                <div class="flip mx-1">
                    <div class="card shadow ">
                        <div class="front ">
                            <span class="fs-1"><img src="./public/img/icons/arte-pintura.png" width="50" alt=""></span>
                            <h5 class="py-2">Dibujo y pintura</h5>
                        </div>
                        <div class="back">
                            <p>El desarrollo gráfico plástico,
                                ...
                                crítico y apreciación de la belleza.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flip mx-1">
                    ...
                    <div class="card shadow ">
                        ...
                        <div class="front ">
                            ...
                            <span class="fs-1"><img src="./public/img/icons/arte-teatro.png" width="50" alt=""></span>


                            <h5 class="py-2">Teatro</h5>

                        </div>

                        <div class="back">

                            <p>El teatro permite la expresión
                ...
                <div class="flip mx-1">
                    ...
                    <div class="card shadow ">
                        ...
                        <div class="front ">
                            ...
                            <span class="fs-1"><img src="./public/img/icons/arte-danza.png" width="50" alt=""></span>


                            <h5 class="py-2">Danza</h5>

                        </div>

                        <div class="back">

                            <p>Con la danza se integra
                ...
                <div class="flip mx-1">
                    ...
                    <div class="card shadow ">
                        ...
                        <div class="front ">
                            ...
                            <span class="fs-1"><img src="./public/img/icons/arte-musica.png" width="50" alt=""></span>


                            <h5 class="py-2">Música</h5>

                        </div>

                        <div class="back">

                            <p>La música forma parte del juego
                                con el sonido, ya sea a través del canto o
                                la interpretación de instrumentos. </p>
    ...
    <br>
    <br>
    <center><?php include_once  './cards-exp.php'; ?></center>
    <!-- <section>
        <div class="container">
            <div class="row h-100">
