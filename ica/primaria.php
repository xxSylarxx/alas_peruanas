    ...
    <section id="historia2">
        <div class="container-fluid">
            <div class="row d-flex justify-content-between">
                ...
                <div class="col-lg-6 p-0">
                    <img src="./public/img/img-page/ica/primaria1.jpg" width="100%" height="500" style="object-fit:cover;" alt="">
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row d-flex justify-content-between">
                <div class="col-lg-6 p-0">
                    <img src="./public/img/img-page/ica/primaria2.jpg" width="100%" height="500" style="object-fit:cover;" alt="">
                </div>
        ...
        <div class="container-fluid">
            <div class="row d-flex justify-content-between">
                ...
                <div class="col-lg-6 p-0">
                    <img src="./public/img/img-page/ica/primaria3.jpg" width="100%" height="500" style="object-fit:cover;" alt="">
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row d-flex justify-content-between">
                <div class="col-lg-6 p-0">
                    <img src="./public/img/img-page/ica/primaria4.jpg" width="100%" height="500" style="object-fit:cover;" alt="">
                </div>
                <div id="bienvenidos-parrafo2" class="col-lg-6 p-0">
                    <div style="padding: 5rem;">
