    ...
    <style>
        ...
        #portada {
            background: linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 1)),
                url('./public/img/img-page/ica/portada_primaria.jpg');
            /* background:linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 1)); */
            background-size: 100%;
            background-position: center; 
            background-attachment: fixed;
        ...
        <div class="container">
            <div class="row d-flex justify-content-around">
                <div class="col-lg-6 mt-4 mb-4">
                    ...
                    <h1 style="text-align:start;color:var(--color3);">Primaria</h1>
                    <div class="separador mx-start"></div>
                ...
                <div class="col-lg-5 mt-4 mb-4">
                    <div class="row ">
                        <div class="col-lg">
                            <p>La educación primaria, en el marco de la formación integral, busca desarrollar en el niño y niña el conocimiento científico, la creatividad, el trabajo en equipo y el ejercicio de su ciudadanía de forma protagónica.</p>
                            <p>La educación Primaria se trabaja bajo el modelo clásico, para lograr el aprendizaje profundo a través de leer, pensar, calcular y escribir. Los contenidos están basados en el CNB e impartidos por docentes especializados en el área.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="historia2">
            ...
            <div class="row d-flex justify-content-between">
                <div id="bienvenidos-parrafo" class="col-lg-6 p-0">
                    <div style="padding: 5rem;">
                        <img src="./public/img/icons/cooperar.png" alt="">

                        <h2>TRABAJO COOPERATIVO</h2>
                        <br>
                        <p>La cooperación se desarrolla entre niños y niñas
                            como una forma de trabajo para favorecer su aprendizaje y confianza
                            en sí mismos donde el maestro interviene haciendo uso de diversos recursos.
                        </p>

                    </div>
                </div>
                <div class="col-lg-6 p-0">
                    <img id="img-parrafo" src="./public/img/img-page/ica/primaria1.jpg" width="100%" height="500" style="object-fit:cover;" alt="">
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row d-flex justify-content-between">
                <div class="col-lg-6 p-0">
                    <img id="img-parrafo" src="./public/img/img-page/ica/primaria2.jpg" width="100%" height="500" style="object-fit:cover;" alt="">
                </div>
                <div id="bienvenidos-parrafo2" class="col-lg-6 p-0">
                    <div style="padding: 5rem;">
                        <img src="./public/img/icons/ciudadania.png" alt="">
                        <h2 style="color:black;">EJERCICIO DE CIUDADANÍA</h2>
                        <br>
        ...
        <div class="container-fluid">
            <div class="row d-flex justify-content-between">
                <div id="bienvenidos-parrafo" class="col-lg-6 p-0">
                    <div style="padding: 5rem;">
                        <img src="./public/img/icons/educacion.png" alt="">
                        <h2>DESARROLLO ACADÉMICO</h2>
                        <br>
                        <p>La actividad del niño y niña se
                ...
                <div class="col-lg-6 p-0">
                    <img id="img-parrafo" src="./public/img/img-page/ica/primaria3.jpg" width="100%" height="500" style="object-fit:cover;" alt="">
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row d-flex justify-content-between">
                <div class="col-lg-6 p-0">
                    <img id="img-parrafo" src="./public/img/img-page/ica/primaria4.jpg" width="100%" height="500" style="object-fit:cover;" alt="">
                </div>
                <div id="bienvenidos-parrafo2" class="col-lg-6 p-0">
                    <div style="padding: 5rem;">
                        <img src="./public/img/icons/formacion.png" alt="">
                        <h2 style="color:black;">FORMACIÓN</h2>
                        <br>
                        <p>Los programas académicos y formativos de este nivel
