...
<div class="main">
    ...
    <ul class="cards">
        <li class="cards_item">
            <div class="card">
                <div class="card_image"><img src="./public/img/img-page/arequipa/secundaria2.jpg" width="614" height="417" style="object-fit:cover;"></div>
                <div class="card_content">
                    <h2 class="card_title">ORIENTACIÓN VOCACIONAL</h2>
                    <br>
                    <p class="card_text">Se ofrece orientación vocacional que facilite su desempeño como futuros 
        ...
        <li class="cards_item">
            <div class="card">
                <div class="card_image"><img src="./public/img/img-page/arequipa/secundaria3.jpg" width="614" height="417" style="object-fit:cover;"></div>
                <div class="card_content">
                    <h2 class="card_title">DESARROLLO CIENTÍFICO INVESTIGATIVO</h2>
                    <br>
