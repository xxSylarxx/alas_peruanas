    ...
    <ul class="cards">
        <li class="cards_item">
            <div class="card">
                ...
                <div class="card_content">
                    <h2 class="card_title text-center">Ajedrez</h2>
                    <br>
                    <!-- <p class="card_text">A través del juego, el niño y la niña se apropian del mundo y sus relaciones con los demás, resuelve conflictos y pone a prueba su inventiva; así mismo es mediado por los demás</p> -->
        ...
        <li class="cards_item">
            <div class="card">
                ...
                <div class="card_content">
                    <h2 class="card_title text-center">Fútbol</h2>
                    <br>
                    <!-- <p class="card_text">Aprende a reconocerse como niño, niña, como miembro de una familia donde puede expresar sus emociones con naturalidad y mucha seguridad.</p> -->
                    <!-- <button class="btn card_btn">Read More</button> -->
                </div>
            </div>
        </li>
        <li class="cards_item">
            <div class="card">
                <div class="card_image"><img src="./public/img/img-page/arequipa/inicial.jpg" width="614" height="417" style="object-fit:cover;"></div>
                <div class="card_content">
                    <h2 class="card_title text-center">Natación</h2>
                    <br>
        ...
        <li class="cards_item">
            <div class="card">
                <div class="card_image"><img src="./public/img/img-page/arequipa/inicial2.jpg" width="614" height="417" style="object-fit:cover;"></div>
                <div class="card_content">
                    <h2 class="card_title text-center">Voley</h2>
                    <br>
