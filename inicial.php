        ...
        <div class="container">
            <div class="row d-flex justify-content-around">
                ...
                <div class="col-lg-5 mt-4 mb-4">
                    <div class="row ">
                        <div class="col-lg">
                            <p>La educación en el nivel inicial de los Colegios Alas
                                Peruanas, se centra en la atención integral de niños y
                                niñas de 3, 4 y 5 años. Es el nivel que establece las
                                bases de la formación de una personalidad integra y
                                protagónica, a través de su participación activa en
                                los contextos de juego y en los proyectos.</p>
                            <p>El proceso de enseñanza aprendizaje,
                                tiene como base el Currículo Nacional y
                                el proyecto Educativo institucional Alas
                                Peruanas.</p>
                            <p>En este nivel se sientan las bases para el desarrollo de las competencias
                                biológicas, afectivas y sociales de los niños y niñas con
                                acciones educativas que facilitan la experiencia directa y
                                la participación de la familia, que apoya con gran entusiasmo
                                las actividades propuestas.</p>
                            <p>Es importante el trabajo conjunto entre
                                padres de familia y docentes. El acompañamiento
                                constante de los alumnos se completa con la comunicación
                                de las tutoras con los padres de familia.</p>
                        </div>
                    </div>
                </div>
            </div>
