        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="d-flex justify-content-center " style="color:var(--color1);">
                    <h2>DEPARTAMENTO PSICOPEDAGÓGICO:</h2>
                </div>
                ...
                <p style="line-height: 2;">
                    ...
                    psicólogo cuyo objetivo principal es el de guiar a los y las estudiantes
                    para que la experiencia educativa le permita alcanzar su máximo desarrollo, descubriendo
                    y potenciando sus fortalezas, así como brindándole el apoyo personal
                    que requiera; enfatizando en la construcción de un vínculo positivo y de
                    relaciones basadas en confianza, a través de un acompañamiento permanente
                    así como el asesoramiento y orientación socio – emocional.
                </p>
            </div>
        </div>
    </section>
